...
@section('title', 'Iniciar Sesión - InventCraft')
...
<div class="container-fluid px-0">
    ...
    <!-- Formulario de login con imagen lateral -->
            ...
            <div class="col-12 col-lg-6">
                <div class="card shadow-lg border-0" style="border-top: 4px solid #4facfe !important;">
                    <div class="card-body p-4">
                        <h2 class="text-center mb-4 fw-bold" style="color: #4facfe;">Iniciar Sesión</h2>
                        ...
                        <form action="{{ route('form.login') }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="email" name="email" value="{{ old('email') }}" required autofocus style="border-color: #4facfe;">
                            </div> 
                            ...
                            <div class="d-grid gap-2 mb-3">
                                <button type="submit" class="btn btn-lg fw-bold text-white" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border: none;">¡A jugar!</button>
                            </div>
                            
                            <div class="text-center">
                                <p class="mb-0">¿No tienes cuenta? <a href="{{ route('register') }}" class="text-decoration-none fw-bold" style="color: #4facfe;">Regístrate aquí</a></p>
                            </div>
                        </form>
                    </div>
                </div>
