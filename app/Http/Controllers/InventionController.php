    ...
    public function store(Request $request) /* TO DO REVISAR porque no elimina los inventos usados para crear otro */
    {
        ...
        $validated = $request->validate($rules, [
         ...
         $new_invention = Invention::create([
             ...
             'name' => Str::random(10),       //Tambien se podría usar el faker
         ...
         $inventoryMaterial = InventoryMaterial::where('material_id', $material_id)->first();
...
*/     
        ...
        Action::create([
             ...
             'actionable_id' => $new_invention->id,
         ...
         return redirect()->route('inventions.show', $new_invention->id)
             ->with('success', 'Invento creado con éxito.');
