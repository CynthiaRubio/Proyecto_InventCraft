...
class FarmZoneRequest extends BaseRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'farmTime' => 'required|integer|min:1',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'farmTime.required' => 'Debes especificar el tiempo de exploración.',
            'farmTime.integer' => 'El tiempo de exploración debe ser un número entero.',
            'farmTime.min' => 'El tiempo de exploración debe ser al menos 1 minuto.',
        ];
    }
}
